...
node-fills archive, reachable by anyone with an AWS account. The finding itself is unflattering
to the venue's ecosystem---it says a widely quoted class of statistic about Hyperliquid is
inflated fivefold---which is the opposite of what a commercial interest would motivate.
...
(2{,}010{,}314 records). The full joinable per-fill file is 119\,MB and is not committed; it
